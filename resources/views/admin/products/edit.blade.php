                            ...
                            <div role="tabpanel" class="tab-pane @if(!request()->has('combination')) active @endif" id="info">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        @endif
                                        @include('admin.products.meta', ['meta' => $productMeta])
                                        <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        const metaattr = $('.meta_attribute input');
        $(metaattr).on('change', function(e) {
            val = {};
            //json_encode
            $(this).parents('.meta_attribute').find(':input:not([type=hidden])').each(function(e1) {
